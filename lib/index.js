const sdk = require('postman-collection'),
  ...
  authorizeCollection = require('./utils').authorizeCollection,
  generator = require('../sdkgen/nodejs-request').generate;
...
async function generate (collection, options, callback) {
  ...
  // authorize each request inside collection by adding necessary queryparam and headers
  authorizeCollection(sources.collection);
